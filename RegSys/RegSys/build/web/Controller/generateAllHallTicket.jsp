...
<html> 
    <head>
        ...
        <title>Generate All Hall Ticket</title>
    ...
    <body onload="load()">
        ...
        <%
           ...
           int cnt=0;
            ...
            if(hallTicketType.equals("pt"))
            {
                ...
                String programmes[]={"CM","IF","ME","ME","CE","CE","EL","EL","EE","DDGM","IDD","PS","AE"};//Array of programmes
               ...
               //Admin_data ad=AdminCon.getAdminInfo();
                for(int i=0;i<13;i++)
                {
                    for(int j=1;j<=3;j++)
                    {
                        ...
                        List li=AdminCon.getRegNoByProgrammePT(programmes[i], shift[i], j,reg_term_year);%>
      ...
      <p></p>
        ...
        else if(hallTicketType.equals("final"))
        {
            ...
            // String branchNames[]={"Computer Technology","Information Technology","Mechanical Engineering","Mechanical Engineering","Civil Engineering","Civil Engineering","Electronics and Telecommunication","Electronics and Telecommunication","Electrical Engineering","Dress designing ang Garment Manufacturing","Interior Design and Decoration","Plastic Engineering","Automobile Engineering"};
            String programmes[]={"CM","IF","ME","ME","CE","CE","EL","EL","EE","DDGM","IDD","PS","AE"};//Array of programmes
            int shift[]={1,1,1,2,1,2,1,2,1,1,1,1,1,1};//Array of shift for esch programme.
            String regno,cou_code;
            Courses course;
            ...
            for(int i=0;i<13;i++)
            {
                ...
                {
                    //li contains regno of students of a particular programme,shift,year.
                    List li=AdminCon.getRegNoByProgrammeFinal(programmes[i], shift[i], j,reg_term_year);%>
