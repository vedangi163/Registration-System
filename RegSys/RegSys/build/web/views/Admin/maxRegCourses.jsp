           ...
           { %>
                ...
                <div class="container">
                    ...
                    <form method="POST" action="../../Controller/saveMaxRegCourses.jsp">
                        <label> Maximum number of allowed courses : </label> <input type="number" name="noOfMaxCourses" required oninvalid="this.setCustomValidity('Maximum courses  is required.')"
