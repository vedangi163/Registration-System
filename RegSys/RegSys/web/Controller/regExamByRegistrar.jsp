...
<html> 
    ...
    <body>
        <%
           ...
           {  
               ...
               List list1=StudCon.getRegCourse(rollNo,stud.getTerm(),stud.getYear());
               ...
               int res[]=StudCon.regExam(courses,rollNo,ad.getReg_term_year(),stud.getTerm(),stud.getYear(),(String)session.getAttribute("registrar_user"));
               try{
               System.out.println("\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n\n*\n*\n*\n*\n");
                   ...
                   for(int k=0;k<courseB.length;k++)
                    { 
                        System.out.print("@@@@@@@@@@@@@@@@@@@@@@  courseB  "+courseB[k]+" @@@@@@@@@@@@@@@@@@"); 
                         ...
                         backCourseResult=StudentCoursesCon.getStudCourseResult(rollNo, courseB[k]);
 ...
 ////////////////////////////////////////////////                   EXCEPTION                       //////
            ...
            response.sendRedirect("../views/Registrar/printRegistration.jsp?rollno="+rollNo);
