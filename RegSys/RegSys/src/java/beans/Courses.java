...
public class Courses {
    private int id,department,year,cou_credit,cou_th_max,cou_pt_max,cou_tw_max,cou_or_max,cou_pr_max,cou_th_min,cou_pt_min,cou_tw_min,cou_or_min,cou_pr_min;
    private String is_exempted,course_name,programme,term,course_code,is_validated,is_offered,cou_pre_r1,cou_pre_r2,cou_pre_r3,cou_pre_r4,cou_remar,c_name,newcode;
