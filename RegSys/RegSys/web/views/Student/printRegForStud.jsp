                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <table border="1" text-align="center">
                            ...
                            <% 
                               List list=StudCon.getRegCourse((String)session.getAttribute("stud_uname"),stud.getTerm(),new Integer(stud.getYear()));
                               List list1=StudCon.getBackCourse((String)session.getAttribute("stud_uname"));
                               Courses course;
